...
namespace ZCFrame
{
    ...
    public class GameEntry : MonoBehaviour
    {
        ...
        /// 基础组件列表
        /// </summary>
        private static readonly LinkedList<ZCBaseComponent> m_BaseComponentList = new LinkedList<ZCBaseComponent>();
        ...
        internal static void RegisterComponent(ZCBaseComponent component)
        {
        ...
        /// <returns></returns>
        public static T GetBaseComponent<T>() where T : ZCBaseComponent
        {
        ...
        /// <returns></returns>
        private static ZCBaseComponent GetBaseComponent(Type type)
        {
            LinkedListNode<ZCBaseComponent> curr = m_BaseComponentList.First;
        ...
        {
            if (!m_UpdateComponentList.Contains(component))
            {
        ...
        {
            for (LinkedListNode<ZCBaseComponent> curr = m_BaseComponentList.First; curr != null; curr = curr.Next)
            {
                curr.Value.Shutdown();
            }
        }
